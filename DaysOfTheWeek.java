...
public class DaysOfTheWeek{
 ...
 // Creating a Scanner object       
        ...
        System.out.printf("Enter todays day: ");
        int date = in.nextInt();
        ...
        if (future_date == 0){
            ...
            System.out.printf("Todays is  and the Future day is Thursday",day_of_week);
        }else if(future_date == 5){
            System.out.printf("Todays is %s and the future day is Friday",day_of_week);
        }else if(future_date ==6){
            System.out.printf("Todays is % and the future day is Saturday",day_of_week);
        }
    }
}